...
if (params.integration){
  umap.i <- MergedSO@reductions$umap.integrated@cell.embeddings
  tsne.i <- MergedSO@reductions$tsne.integrated@cell.embeddings
}
...
if (length(SeuratObjList) > 1){
  ...
  if (params.integration){
    write.csv(umap, file = paste0("projections/seurat_umap.integrated", params.ProjectName,".csv"), col.names = NA, quote = FALSE, row.names = TRUE)
  write.csv(tsne, file = paste0("projections/seurat_tsne.integrated", params.ProjectName,".csv"), col.names = NA, quote = FALSE, row.names = TRUE)
  }
