...
```{r}
# Working Directory
params.workingdir        <- json_data$working_dir
...
for (samp in SeuratObjList){
    ...
    pdf(paste0("./figures/single_cell/",params.ProjectName,"_",samp,"_ElbowPlot.pdf"), 
        width = 20, height = 15)
    print(Elbow)
    dev.off()
    print(Elbow)
...
write.csv(cell_cluster_idents, file = paste0("clustering/seurat_clusters.", params.ProjectName,".csv"), col.names = NA, quote = FALSE, row.names = TRUE)
```
